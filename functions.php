...
$array=array(
    ...
    */
    'Home'=>'/corsomarianna/index.php',
    'il mio blog'=>'/corsomarianna/blog.php',
    'Login'=>'/corsomarianna/login.php'
    /*
...
if(isset($_COOKIE['LOGIN'])){
    ...
    $array['admin'] = '/corsomarianna/admin/admin.php';
...
$arrayAdmin=array(
    'Pagine'=>'#',
    'Post'=>'/corsomarianna/admin/adminPost.php'
);
